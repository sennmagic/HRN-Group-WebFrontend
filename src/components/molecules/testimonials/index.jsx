      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`text-center relative ${
          ...
          <button
            ...
            className="absolute left-2 sm:left-4 top-1/2 transform -translate-y-1/2 w-10 h-10 sm:w-12 sm:h-12 bg-blue-300 bg-opacity-30 rounded-full flex items-center justify-center text-blue-100 hover:bg-opacity-50 hover:text-white transition-all duration-300"
          >
