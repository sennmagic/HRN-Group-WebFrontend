...
const MemberText = ({ member }) => (
  <div className="flex-1 self-start">
    <p className="text-yellow-500 font-bold tracking-widest text-sm md:text-base uppercase">
      {member.nameEn}
    </p>
  ...
  return (
    <div className="w-full bg-slate-900">
      ...
      <div className="w-full flex items-start justify-center px-6 md:px-10 py-10 md:py-14">
        <div className="w-full max-w-7xl flex flex-col md:flex-row gap-8 md:gap-14 items-start">

          {/* Chairman photo + name below */}
          <div className="flex-shrink-0 flex flex-col items-center w-full md:w-64">
            <img
              src="https://i.pravatar.cc/400?img=57"
              alt="Acharya Prakash"
              className="w-48 md:w-full object-cover object-top"
            />
            <div className="mt-4 text-center">
              <p className="text-yellow-500 font-bold tracking-widest text-sm uppercase">
                ACHARYA PRAKASH
              </p>
          ...
          <div className="flex-1 pt-0">
            <h1 className="text-yellow-500 text-3xl md:text-5xl font-semibold tracking-widest mb-8">
              会長あいさつ
            </h1>
      ...
      <div className="w-full flex items-start justify-center px-6 md:px-10 py-10 md:py-14">
        <div className="w-full max-w-7xl flex flex-col">
          ...
          {boardMembers.map((member, index) => {
            ...
            return (
              <div key={member.id}>
                ...
                {index > 0 && (
                  <div className="w-full h-px bg-yellow-600 opacity-40 my-10 md:my-14" />
                )}
          ...
          <div className="text-right text-gray-400 text-sm mt-10">9</div>
        </div>
      </div>
